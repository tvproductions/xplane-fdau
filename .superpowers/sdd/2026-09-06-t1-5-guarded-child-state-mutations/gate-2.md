...
The first command passed 106 tests in the accepted rereview, including the
named hash, stale-state, and fresh-audit race cases. The second passed 449
discovery and 449 coverage tests at 94%, with every configured analyzer
passing.
