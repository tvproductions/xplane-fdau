...
| `T2.1` | Project repository-hygiene adapter and fresh artifact verification | `in_progress` | `T1.6` | [design](docs/superpowers/specs/2026-08-15-xplane-fdau-local-workflow-skills-design.md) | [plan](docs/superpowers/plans/2026-09-19-t2-1-repository-hygiene-artifact-verification.md) | 0/5 | — | — | — |
