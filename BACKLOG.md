...
| `T1.5` | Guarded child-state and gate-evidence mutations | `in_progress` | `T1.3`, `T1.4` | [design](docs/superpowers/specs/2026-08-09-xplane-fdau-backlog-status-skill-design.md) | [plan](docs/superpowers/plans/2026-09-06-t1-5-guarded-child-state-mutations.md) | 0/5 | — | — | — |
