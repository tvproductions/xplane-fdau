...
- `D1.1`, `D1.2`, and `D1.3` are verified. The statusless external `I1.0`
  ...
  `T1.3` is selected and `planned` with 0/4 gates under its approved audit
...
| `T1.3` | Structural audit and spec/plan adherence | `planned` | `T1.2` | [design](docs/superpowers/specs/2026-09-05-t1-3-audit-policy-supplement-design.md) | [plan](docs/superpowers/plans/2026-09-05-t1-3-structural-audit.md) | 0/4 | — | — | — |
