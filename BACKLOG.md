...
| `T1.6` | Skill, session-entry, hygiene, and artifact closure | `in_progress` | `T1.5` | [design](docs/superpowers/specs/2026-08-09-xplane-fdau-backlog-status-skill-design.md) | [plan](docs/superpowers/plans/2026-09-07-t1-6-skill-session-hygiene-artifact-closure.md) | 0/5 | — | — | — |
