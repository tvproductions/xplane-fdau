...
| --- | --- | --- | --- | --- | --- | --- |
| `T1.1` | Markdown authority contract and inventory normalization | `specified` | `M0` | [design](docs/superpowers/specs/2026-08-09-xplane-fdau-backlog-status-skill-design.md) | [draft plan](docs/superpowers/plans/2026-08-15-xplane-fdau-backlog-authority-normalization.md) | 0/4 |
